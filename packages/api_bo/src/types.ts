...
export type CenterResolvers<ContextType = any, ParentType extends ResolversParentTypes['Center'] = ResolversParentTypes['Center']> = ResolversObject<{
  ...
  contacts?: Resolver<Maybe<Array<Maybe<ResolversTypes['ContactCenter']>>>, ParentType, ContextType>;
  ...
  typeActivities?: Resolver<ResolversTypes['TypeActivities'], ParentType, ContextType>;
...
export type GroupResolvers<ContextType = any, ParentType extends ResolversParentTypes['Group'] = ResolversParentTypes['Group']> = ResolversObject<{
  ...
  timetable?: Resolver<Maybe<Array<Maybe<ResolversTypes['String']>>>, ParentType, ContextType>;
...
export type InstructorResolvers<ContextType = any, ParentType extends ResolversParentTypes['Instructor'] = ResolversParentTypes['Instructor']> = ResolversObject<{
  ...
  geographicalAvailability?: Resolver<Maybe<Array<Maybe<ResolversTypes['String']>>>, ParentType, ContextType>;
  groups?: Resolver<Maybe<Array<Maybe<ResolversTypes['Group']>>>, ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  languages?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  materialExperience?: Resolver<Maybe<Array<Maybe<ResolversTypes['String']>>>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  notes?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  personalEmail?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  phone?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  platformEducationExperience?: Resolver<Maybe<Array<Maybe<ResolversTypes['String']>>>, ParentType, ContextType>;
  previousExperience?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  programmingExperience?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  state?: Resolver<ResolversTypes['State'], ParentType, ContextType>;
  summerAvailability?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  surname?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  typeVehicle?: Resolver<ResolversTypes['TypeVehicle'], ParentType, ContextType>;
  vehicle?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  addContactCenter?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<MutationAddContactCenterArgs, 'email' | 'idCenter' | 'name' | 'phone' | 'surname'>>;
  createCenter?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<MutationCreateCenterArgs, 'address' | 'course' | 'email' | 'languages' | 'modality' | 'name' | 'nature' | 'phone' | 'population' | 'type' | 'typeActivities'>>;
}>;
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  getCenters?: Resolver<Array<ResolversTypes['Center']>, ParentType, ContextType>;
}>;
...
export type StudentResolvers<ContextType = any, ParentType extends ResolversParentTypes['Student'] = ResolversParentTypes['Student']> = ResolversObject<{
  ...
  center?: Resolver<ResolversTypes['Center'], ParentType, ContextType>;
  collectionAuthorisation?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  imageAuthorisation?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  notes?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;

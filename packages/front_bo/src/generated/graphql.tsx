  ...
  getCenters: {
    ...
    data?: Array<{
      ...
      groups: Array<{
        ...
        createdAt: string;
        course: string;
        timetable: Array<{ __typename?: "Timetable"; day: Days }>;
      }>;
    } | null> | null;
  };
};
 ...
 * });
 */
export function useGetCentersQuery(
  ...
  return Apollo.useQuery<GetCentersQuery, GetCentersQueryVariables>(
    GetCentersDocument,
    options
  );
}
export function useGetCentersLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetCentersQuery, GetCentersQueryVariables>(
    GetCentersDocument,
    options
  );
}
export type GetCentersQueryHookResult = ReturnType<typeof useGetCentersQuery>;
export type GetCentersLazyQueryHookResult = ReturnType<
  typeof useGetCentersLazyQuery
>;
export type GetCentersQueryResult = Apollo.QueryResult<
  GetCentersQuery,
  GetCentersQueryVariables
>;
